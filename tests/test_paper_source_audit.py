...
class PaperSourceAuditTests(unittest.TestCase):
    def test_rolling_spinning_implicit_rbd_source_audit_is_fail_closed(self) -> None:
        ...
        for key, snippet in (
            ...
            ("implicit_rbd_timing_context", "implicit RBD"),
    ...
    def test_rolling_spinning_implicit_rbd_source_disclosure_triggers_manual_review(
        self,
    ) -> None:
        with TemporaryDirectory() as tmpdir:
            ...
            _write_source_fixture(
                ...
                omitted_file_text=(
                    ...
                    "uses Coulomb friction with no-slip. The implicit RBD integrator is "
                    "backward Euler with Newton iterations and collision parameters ke kd kf mu."
                ),
            )

            audit = rolling_spinning_implicit_rbd_source_audit(source_root)
        ...
        self.assertIn("implicit_rbd_source_disclosure_found", audit.blockers)
